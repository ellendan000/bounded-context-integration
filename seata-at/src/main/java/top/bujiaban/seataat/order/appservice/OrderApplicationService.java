...
import top.bujiaban.seataat.order.domain.OrderStatus;
import top.bujiaban.seataat.order.infrastructure.client.InventoryFeignClient;
...
public class OrderApplicationService {
    ...
    public OrderApplicationService(InventoryFeignClient inventoryFeignClient,
